    ...
    <div>
      ...
      <div id="Crude_Boilover-box">
        ...
        <div className="d-flex flex-column justify-content-end CBoilover-flexbox4">
          ...
          <div id="PreChecks" className="box2">Adverse Weather Pre-Checks</div> 
        </div>
        ...
        <div className="d-flex flex-column  CBoilover-flexbox2">
               ...
               <div className="d-flex flex-row align-items-center CBoilOver_tanksbox">
                ...
                <div id="Containment" className="box2">Containment</div>               
                <div id="Emergency" className="box2">CSG: Emergency Response Plan & Associated Facilities</div>
                <div id="Detection" className="box2">Detection</div>
                <div id="Mitigation" className="box2">CSG: Boilover Mitigation Measures</div>
        ...
        <div className="d-flex flex-column">
            <p id="Boilover" className="box1">Boilover</p>
        </div>
        ...
        {/* empty divs for arrows */}
            ...
            <div id="e22" className="d-flex"></div>
